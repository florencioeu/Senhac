...
<head>
  ...
  <script src="JS/senhac.js" defer></script> 
  <script src="JS/banco_pedidos.js" defer></script>
...
<body class="light-theme">
  ...
  <header class="top-bar" id="header">
    <img src="imagens/senhac I.png" alt="Logo Senhac" />
  ...
  <div id="page-wrapper">
    <section class="banner">
      <img src="imagens/banner2.png" alt="Banner" />
    ...
    <main class="categorias" id="mainContent">
      <a href="ofertas.html" class="categoria">
        <img src="imagens/ofertas.png" alt="Ofertas" />
        <p>Ofertas do Dia</p>
      </a>
      ...
      <a href="Doces.html" class="categoria">
        <img src="imagens/doces.png" alt="Doces" />
        <p>Doces</p>
      </a>
      <a href="Lanches.html" class="categoria">
        <img src="imagens/lanches.png" alt="Lanches" />
        <p>Lanches</p>
      </a>
      <a href="Todos.html" class="categoria">
        <img src="imagens/todos os itens.png" alt="Todos os Itens" />
        <p>Todos os Itens</p>
      </a>
      <a href="meus-pedidos.html" class="categoria">
      <img src="imagens/pedido.png" alt="Meus Pedidos" />
     <p>Meus Pedidos</p>
     </a>
    </main>
    ...
    <div class="app-download">
      <a href="https://play.google.com/store/apps/details?id=br.sp.senac&hl=pt_BR" target="_blank">
        <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Disponível no Google Play" class="store-badge" />
      </a>
      <a href="https://apps.apple.com/br/app/senac-s%C3%A3o-paulo/id1454496991" target="_blank">
        <img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="Disponível na App Store" class="store-badge" />
      </a>
    </div>
  </div>
...
<div id="modalPerfil" class="modal" aria-hidden="true" role="dialog" aria-labelledby="modalTitulo" aria-modal="true">
  <div class="modal-content">
    ...
    <img src="imagens/perfil (2).png" alt="Foto de Perfil" />
